...
if authentication_status :
    ...
    def main():
        ...
        if name == "ADMIN" :
            Tables_admin = ["Customer", "Customer Phone", "Dependents", "Product", "Shopkeeper", "Shopkeeper Phone","Shopkeeper Product", "Sale"]
            ...
            Tables_shopkeeper = ["Bill", "Bill Product", "Product Customer", "Shopkeeper Product", "Sell", "Sale"]
